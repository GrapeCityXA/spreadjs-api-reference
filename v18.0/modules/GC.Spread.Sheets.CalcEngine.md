...
// 使用EvaluateFormula()方法来计算公式，而无需在工作表的单元格中设置公式
...
| :------ | :------ | :------ |
| `context` | `Object` | 上下文；通常，您应该使用活跃工作表对象 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `changingSheet` | [`Worksheet`](../classes/GC.Spread.Sheets.Worksheet.md) | 包含要调整单元格的工作表 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `range` | [`Range`](../classes/GC.Spread.Sheets.Range.md) | 工作表中的单元格区域 |
| `baseRow?` | `number` | - |
| `baseCol?` | `number` | - |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `ranges` | [`Range`](../classes/GC.Spread.Sheets.Range.md)[] | 工作表中的单元格区域 |
| `baseRow?` | `number` | - |
| `baseCol?` | `number` | - |
| `rangeReferenceRelative?` | [`RangeReferenceRelative`](../enums/GC.Spread.Sheets.CalcEngine.RangeReferenceRelative.md) | - |
| `useR1C1?` | `boolean` | - |
