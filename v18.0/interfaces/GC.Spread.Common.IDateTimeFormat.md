...
[Spread](../modules/GC.Spread.md).[Common](../modules/GC.Spread.Common.md).IDateTimeFormat

## Table of contents

### Properties

- [abbreviatedDayNames](GC.Spread.Common.IDateTimeFormat.md#abbreviateddaynames)
- [abbreviatedMonthGenitiveNames](GC.Spread.Common.IDateTimeFormat.md#abbreviatedmonthgenitivenames)
- [abbreviatedMonthNames](GC.Spread.Common.IDateTimeFormat.md#abbreviatedmonthnames)
- [amDesignator](GC.Spread.Common.IDateTimeFormat.md#amdesignator)
- [dayNames](GC.Spread.Common.IDateTimeFormat.md#daynames)
- [defaultDatePattern](GC.Spread.Common.IDateTimeFormat.md#defaultdatepattern)
- [fullDateTimePattern](GC.Spread.Common.IDateTimeFormat.md#fulldatetimepattern)
- [longDatePattern](GC.Spread.Common.IDateTimeFormat.md#longdatepattern)
- [longTimePattern](GC.Spread.Common.IDateTimeFormat.md#longtimepattern)
- [monthDayPattern](GC.Spread.Common.IDateTimeFormat.md#monthdaypattern)
- [monthGenitiveNames](GC.Spread.Common.IDateTimeFormat.md#monthgenitivenames)
- [monthNames](GC.Spread.Common.IDateTimeFormat.md#monthnames)
- [pmDesignator](GC.Spread.Common.IDateTimeFormat.md#pmdesignator)
- [shortDatePattern](GC.Spread.Common.IDateTimeFormat.md#shortdatepattern)
- [shortTimePattern](GC.Spread.Common.IDateTimeFormat.md#shorttimepattern)
- [yearMonthPattern](GC.Spread.Common.IDateTimeFormat.md#yearmonthpattern)
...
指定单元格格式化程序为空或“常规”且单元格值为带时间的日期的情况下的默认日期格式化程序。
