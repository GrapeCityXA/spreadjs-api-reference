...
一个可编辑的CheckBoxList单元格

**`代码示例`**
``` javascript
//本示例创建一个CheckBoxList单元格
...
获取或设置复选框大小的文本，仅支持数字和"auto"如果使用非法值，则大小不会更改
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` \| `number` | 复选框的大小如果值为"auto",单选按钮的大小将随字体大小而改变 |

#### Returns

`any`

如果未设置值，则返回复选框的大小否则，返回复选框列表cellType
...
如果未设置任何值，则返回复选框列表的顺序是否垂直 否则，返回复选框列表cellType
...
如果未设置任何值，则返回布局是否为自动调整，返回复选框列表cellType
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`IItemSpacing`](../interfaces/GC.Spread.Sheets.CellTypes.IItemSpacing.md) | 复选框列表中两个项的空间 |

#### Returns

`any`

如果未设置任何值，则返回复选框列表中两个项的空间；否则，返回复选框列表cellType
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `items?` | `string`[] \| [`ICelltypeItemOption`](../interfaces/GC.Spread.Sheets.CellTypes.ICelltypeItemOption.md)[] | 复选框列表的项 |

#### Returns

`any`

如果未设置任何值，则返回items数组 否则，返回复选框列表cellType
...
如果未设置任何值，则返回列数 否则，返回复选框列表cellType
...
如果未设置任何值，则返回行数；否则，返回复选框列表cellType
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`TextAlign`](../enums/GC.Spread.Sheets.CellTypes.TextAlign.md) | 复选框位置的文本 |

#### Returns

`any`

如果未设置任何值，则返回复选框位置的文本，返回复选框列表cellType
