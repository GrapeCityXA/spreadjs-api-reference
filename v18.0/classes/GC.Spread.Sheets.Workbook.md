...
- [applyOp](GC.Spread.Sheets.Workbook.md#applyop)
...
- [fromSnapshot](GC.Spread.Sheets.Workbook.md#fromsnapshot)
...
- [onOp](GC.Spread.Sheets.Workbook.md#onop)
...
- [toSnapshot](GC.Spread.Sheets.Workbook.md#tosnapshot)
...
| `type` | [`SheetType`](../enums/GC.Spread.Sheets.SheetType.md) | 工作表标签类型 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `sparklineEx` | [`SparklineEx`](GC.Spread.Sheets.Sparklines.SparklineEx.md) | 要添加的SparklineEx： <br /> window.MySparklineEx = function (color) {<br />    GC.Spread.Sheets.Sparklines.SparklineEx.apply(this, arguments);<br />    this.typeName = 'MySparklineEx';<br />    this.color = color;<br />}<br />MySparklineEx.prototype = new GC.Spread.Sheets.Sparklines.SparklineEx();<br />MySparklineEx.prototype.createFunction = function () {<br />    var func = new GC.Spread.CalcEngine.Functions.Function('CIRCLE', 0, 0);<br />    func.evaluate = function (args) { return {}; };<br />    return func;<br />};<br />MySparklineEx.prototype.paint = function (context, value, x, y, width, height) {<br />    context.beginPath();<br />    context.arc(x + width / 2, y + height / 2,<br />        (Math.min(width, height) - 6) / 2, 0, Math.PI * 2);<br />    context.strokeStyle = this.color; context.stroke();<br />};<br />spread.addSparklineEx(new MySparklineEx('green')); |
...
### <a id="applyop" name="applyop"></a> applyOp
...
// 由于没有指定特定的主题，上面的切片器将使用“custom0”作为主题。
...
let newTable = activeSheet.tables.add("table1", 1, 1, 10, 5); 
// 由于未指定特定主题，上述表格将使用 "custom0" 作为主题。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `workbookData` | `Object` | 反序列化的工作表数据 |
| `deserializationOptions?` | `Object` | 反序列化的配置项 [IDeserializationOptions](../interfaces/GC.Spread.Sheets.IDeserializationOptions.md) |

#### Returns

`Promise`<`any`\>

- `fromJSON` 方法所返回的 Promise 对象。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `name` | `string` | 工作表选项卡的名字 |

#### Returns

`number`

工作表选项卡位置，基于工作表和集算表的集合
...
- 命中测试信息 如果选择工作表，则返回工作表信息 该信息包含x,y和worksheetHitInfo;
...
如果未设置任何值，则返回下一个控件；否则，返回工作表

___

### <a id="onop" name="onop"></a> onOp
...
返回工作表的页面信息，如果忽略工作表索引，则返回数组中所有工作表的页面信息
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `indexOrName` | `string` \| `number` | 用于创建活动工作表选项卡的索引或名称 |
...
获取或设置要在工作表中显示的第一张工作表的索引

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `number` | 要在工作表中显示的第一张工作表的索引 |

#### Returns

`any`

如果未设置任何值，则返回工作表中显示的第一张工作表的索引；否则，返回工作表
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `ignoreDirty?` | `boolean` | 是否忽略掉对脏值的处理 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `serializationOption?` | `Object` | 序列化的配置项 [ISerializationOption](../interfaces/GC.Spread.Sheets.ISerializationOption.md) |
