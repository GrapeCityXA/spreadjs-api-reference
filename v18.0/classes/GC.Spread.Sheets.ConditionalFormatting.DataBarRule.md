...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`Range`](GC.Spread.Sheets.Range.md)[] | 条件规则范围 |

#### Returns

`any`

如果未设置值，则返回条件规则范围；否则，返回条件规则
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 是否要画边界 |

#### Returns

`any`

如果未设置值，返回指示是否绘制边框的值；否则，返回数据栏规则
