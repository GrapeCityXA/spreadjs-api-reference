...
| `name` | `string` | 数据图表的名称。 |
| `x` | `number` | 数据图表的 x 坐标位置。 |
| `y` | `number` | 数据图表的 y 坐标位置。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 是否禁用数据图表移动功能的设置。 |

#### Returns

`any`

如果未设置值，则返回是否禁用数据图表移动功能的设置；否则，返回该数据图表。
...
获取或设置是否禁用数据图表的大小调整功能。

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 是否禁用数据图表大小调整功能的设置。 |

#### Returns

`any`

如果未设置值，则返回是否禁用数据图表大小调整功能的设置；否则，返回该数据图表。
...
获取或设置当隐藏、显示、调整大小或移动行或列时，该对象是否移动。

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 表示当隐藏、显示、调整大小或移动行或列时，该对象是否移动的值。 |

#### Returns

`any`

如果未设置值，则返回此数据图表是否动态移动；否则，返回该数据图表。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 表示数据图表位置是否固定的值。 |

#### Returns

`any`

如果未设置值，则返回数据图表的位置是否固定；否则，返回该数据图表。
...
如果未设置值，则返回数据图表位置的结束列索引；否则，返回该数据图表。
...
如果未设置值，则返回相对于数据图表结束列的偏移量；否则，返回该数据图表。
...
如果未设置值，则返回数据图表位置的结束行索引；否则，返回该数据图表。
...
如果未设置值，则返回相对于数据图表结束行的偏移量；否则，返回该数据图表。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 表示此数据图表是否被锁定的值。 |

#### Returns

`any`

如果未设置值，则返回此数据图表是否被锁定；否则，返回该数据图表。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 表示此数据图表是否被选中的值。 |

#### Returns

`any`

如果未设置值，则返回此数据图表是否被选中；否则，返回该数据图表。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 表示此数据图表是否可见的值。 |

#### Returns

`any`

如果未设置值，则返回此数据图表是否可见；否则，返回该数据图表。
...
如果未设置值，则返回数据图表位置的起始列索引；否则，返回该数据图表。
...
如果未设置值，则返回相对于数据图表起始列的偏移量；否则，返回该数据图表。
...
如果未设置值，则返回数据图表位置的起始行索引；否则，返回该数据图表。
...
如果未设置值，则返回相对于数据图表起始行的偏移量；否则，返回该数据图表。
...
如果未设置值，则返回数据图表的水平位置；否则，返回该数据图表。
...
如果未设置值，则返回数据图表的垂直位置；否则，返回该数据图表。
