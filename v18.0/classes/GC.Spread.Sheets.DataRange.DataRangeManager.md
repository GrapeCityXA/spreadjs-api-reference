...
| :------ | :------ | :------ |
| `sheet` | [`Worksheet`](GC.Spread.Sheets.Worksheet.md) | 工作表对象。 |
...
| :------ | :------ | :------ |
| `name` | `string` | 数据范围的名称。 |
| `dataProvider` | `string` \| [`IDataProvider`](../interfaces/GC.Spread.Sheets.DataRange.IDataProvider.md) | 数据提供者。字符串类型表示表工作表的名称，它将创建一个表工作表数据提供者。 |
| `range` | [`Range`](GC.Spread.Sheets.Range.md) | 数据范围的区域。 |
