...
如果未设置值，则返回切片器的是否显示横向滚动条选项值；否则，返回切片器对象。
...
如果未设置值，则返回切片器的是否显示选择标签选项值；否则，返回切片器对象。
...
如果未设置值，则返回切片器的是否显示时间等级选项值；否则，返回切片器对象。
