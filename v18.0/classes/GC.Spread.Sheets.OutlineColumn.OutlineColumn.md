...
| :------ | :------ | :------ |
| `sheet` | [`Worksheet`](GC.Spread.Sheets.Worksheet.md) | 区域分组列的工作表   |
...
如果行是undefined,则返回所有行的检查状态；否则，返回该行的检查状态
...
如果行是undefined,则返回所有行的折叠状态；否则，返回该行的折叠设置
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `outlineColumnOptions?` | [`IOutlineColumnOptions`](../interfaces/GC.Spread.Sheets.OutlineColumn.IOutlineColumnOptions.md) | outlineColumn选项 |
...
如果没有设置outlineColumnOptions,则返回outlineColumnOptions;否则，返回outlineColumn实例
