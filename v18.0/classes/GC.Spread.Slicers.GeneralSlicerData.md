...
| `range?` | [`ISlicerRangeConditional`](../interfaces/GC.Spread.Slicers.ISlicerRangeConditional.md) | 具体范围 |
...
添加监听器。SlicerData 将在适当的时候调用相应的接口。
...
// 创建一个自定义切片器并将其添加到Id为 slicerContainer 的div中。
