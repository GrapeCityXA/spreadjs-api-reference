...
将数据透视面板附加到数据透视表，然后数据透视面板可以控制绑定的数据透视表。

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `pivotTable` | [`PivotTable`](GC.Spread.Pivot.PivotTable-1.md) | 绑定的数据透视表 |
...
将数据透视面板与数据透视表分离，停止数据透视面板对绑定的数据透视表的控制。
