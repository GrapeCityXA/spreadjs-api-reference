...
| `sheetNames?` | `string`[] | 应用标签样式的表单名称数组 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `sheetNames?` | `string`[] | 查询状态样式的表单名称数组 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `sheetNames?` | `string`[] | 需要清除样式的表单名称数组 |
...
| :------ | :------ | :------ |
| `state` | [`SheetTabState`](../enums/GC.Spread.Sheets.SheetTabState.md) | 标签状态 |
| `sheetNames?` | `string`[] | 需要删除样式的表单名称数组  |
