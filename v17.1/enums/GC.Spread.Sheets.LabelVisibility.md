...
[Spread](../modules/GC.Spread.md).[Sheets](../modules/GC.Spread.Sheets.md).LabelVisibility
...
- [auto](GC.Spread.Sheets.LabelVisibility.md#auto)
- [hidden](GC.Spread.Sheets.LabelVisibility.md#hidden)
- [visible](GC.Spread.Sheets.LabelVisibility.md#visible)
...
• **auto** = `2`
 ...
 单元格有值时在填充区域中显示水印，或者在单元格没有值时在单元格区域中显示水印
...
• **hidden** = `1`
 ...
 不根据单元格值条件格式在填充区域中显示水印，而是在单元格区域中显示水印
...
• **visible** = `0`
 ...
 无论单元格值如何，始终在填充区域中显示水印，而不在单元格区域中显示水印
