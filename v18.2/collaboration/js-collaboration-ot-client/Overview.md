...
- [ERROR\_CODES](enums/ERROR_CODES.md)
- [MessageActions](enums/MessageActions.md)

### Classes

- [OTError](classes/OTError.md)
- [SharedDoc](classes/SharedDoc.md)
...
- [IHistorySnapshotRequestOptions](interfaces/IHistorySnapshotRequestOptions.md)
- [IIdToError](interfaces/IIdToError.md)
- [IOp](interfaces/IOp.md)
- [IOptions](interfaces/IOptions.md)
- [IReplyMessage](interfaces/IReplyMessage.md)
- [IRequestMessage](interfaces/IRequestMessage.md)
- [ISharedDocEvents](interfaces/ISharedDocEvents.md)
