...
获取或设置此任务的持续时间。
允许设置数字或字符串值来表示持续时间，获取结果将始终是有效的 [GC.Spread.Sheets.GanttSheet.Duration](../modules/GC.Spread.Sheets.GanttSheet.md#duration) 对象。
...
获取包含此任务所有前置任务的 [GC.Spread.Sheets.GanttSheet.TaskDependency](GC.Spread.Sheets.GanttSheet.TaskDependency.md) 数组。
...
获取包含此任务所有后续任务的 [GC.Spread.Sheets.GanttSheet.TaskDependency](GC.Spread.Sheets.GanttSheet.TaskDependency.md) 数组。
