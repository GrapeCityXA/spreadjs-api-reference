...
[Sheets](../modules/GC.Spread.Sheets.md).[CellTypes](../modules/GC.Spread.Sheets.CellTypes.md).Base

## Hierarchy

- **`Base`**

  ↳ [`Button`](GC.Spread.Sheets.CellTypes.Button.md)

  ↳ [`ButtonList`](GC.Spread.Sheets.CellTypes.ButtonList.md)

  ↳ [`CheckBox`](GC.Spread.Sheets.CellTypes.CheckBox.md)

  ↳ [`CheckBoxList`](GC.Spread.Sheets.CellTypes.CheckBoxList.md)

  ↳ [`ColumnHeader`](GC.Spread.Sheets.CellTypes.ColumnHeader.md)

  ↳ [`ComboBox`](GC.Spread.Sheets.CellTypes.ComboBox.md)

  ↳ [`Corner`](GC.Spread.Sheets.CellTypes.Corner.md)

  ↳ [`FileUpload`](GC.Spread.Sheets.CellTypes.FileUpload.md)

  ↳ [`HyperLink`](GC.Spread.Sheets.CellTypes.HyperLink.md)

  ↳ [`RadioButtonList`](GC.Spread.Sheets.CellTypes.RadioButtonList.md)

  ↳ [`RangeTemplate`](GC.Spread.Sheets.CellTypes.RangeTemplate.md)

  ↳ [`RowHeader`](GC.Spread.Sheets.CellTypes.RowHeader.md)
...
- [constructor](GC.Spread.Sheets.CellTypes.Base.md#constructor)

### Properties

- [typeName](GC.Spread.Sheets.CellTypes.Base.md#typename)

### Methods

- [activateEditor](GC.Spread.Sheets.CellTypes.Base.md#activateeditor)
- [createEditorElement](GC.Spread.Sheets.CellTypes.Base.md#createeditorelement)
- [deactivateEditor](GC.Spread.Sheets.CellTypes.Base.md#deactivateeditor)
- [focus](GC.Spread.Sheets.CellTypes.Base.md#focus)
- [format](GC.Spread.Sheets.CellTypes.Base.md#format)
- [fromJSON](GC.Spread.Sheets.CellTypes.Base.md#fromjson)
- [getAutoFitHeight](GC.Spread.Sheets.CellTypes.Base.md#getautofitheight)
- [getAutoFitWidth](GC.Spread.Sheets.CellTypes.Base.md#getautofitwidth)
- [getEditorValue](GC.Spread.Sheets.CellTypes.Base.md#geteditorvalue)
- [getHitInfo](GC.Spread.Sheets.CellTypes.Base.md#gethitinfo)
- [isEditingValueChanged](GC.Spread.Sheets.CellTypes.Base.md#iseditingvaluechanged)
- [isImeAware](GC.Spread.Sheets.CellTypes.Base.md#isimeaware)
- [isReservedKey](GC.Spread.Sheets.CellTypes.Base.md#isreservedkey)
- [paint](GC.Spread.Sheets.CellTypes.Base.md#paint)
- [paintContent](GC.Spread.Sheets.CellTypes.Base.md#paintcontent)
- [parse](GC.Spread.Sheets.CellTypes.Base.md#parse)
- [processKeyDown](GC.Spread.Sheets.CellTypes.Base.md#processkeydown)
- [processKeyUp](GC.Spread.Sheets.CellTypes.Base.md#processkeyup)
- [processMouseDown](GC.Spread.Sheets.CellTypes.Base.md#processmousedown)
- [processMouseEnter](GC.Spread.Sheets.CellTypes.Base.md#processmouseenter)
- [processMouseLeave](GC.Spread.Sheets.CellTypes.Base.md#processmouseleave)
- [processMouseMove](GC.Spread.Sheets.CellTypes.Base.md#processmousemove)
- [processMouseUp](GC.Spread.Sheets.CellTypes.Base.md#processmouseup)
- [selectAll](GC.Spread.Sheets.CellTypes.Base.md#selectall)
- [setEditorValue](GC.Spread.Sheets.CellTypes.Base.md#seteditorvalue)
- [toJSON](GC.Spread.Sheets.CellTypes.Base.md#tojson)
- [updateEditor](GC.Spread.Sheets.CellTypes.Base.md#updateeditor)
- [updateEditorContainer](GC.Spread.Sheets.CellTypes.Base.md#updateeditorcontainer)
- [updateImeMode](GC.Spread.Sheets.CellTypes.Base.md#updateimemode)
