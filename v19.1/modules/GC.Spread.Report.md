...
**`property`** {GC.Spread.Report.IWriteBackRule} rule - 报告表数据条目写回规则。

#### Type declaration

| Name | Type | Description |
| :------ | :------ | :------ |
| `deleteRecords` | [`IRecord`](../interfaces/GC.Spread.Report.IRecord.md)[] | 删除的记录。 |
| `records` | [`IRecord`](../interfaces/GC.Spread.Report.IRecord.md)[] | 更新的和插入的记录。 |
| `rule` | [`IWriteBackRule`](../interfaces/GC.Spread.Report.IWriteBackRule.md) | 报告表数据条目写回规则。 |
...
Ƭ **GroupCell**: [`IDataCellBase`](../interfaces/GC.Spread.Report.IDataCellBase.md) & { `bins?`: [`IGroupBin`](../interfaces/GC.Spread.Report.IGroupBin.md)[] ; `fixedFillCount?`: `number` ; `formula?`: [`Formula`](GC.Spread.Report.md#formula) ; `type`: ``"Group"``  }
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `sheet` | [`Worksheet`](../classes/GC.Spread.Sheets.Worksheet.md) | 初始化参数面板，用户可以在此更新参数面板。 |
...
Ƭ **ListCell**: [`IDataCellBase`](../interfaces/GC.Spread.Report.IDataCellBase.md) & { `fixedFillCount?`: `number` ; `spillMode?`: ``"Insert"`` \| ``"Overwrite"`` ; `type`: ``"List"``  }
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `sheet` | [`ReportSheet`](../classes/GC.Spread.Report.ReportSheet.md) | 参数面板绑定的报告表。 |
| `changedArgs` | [`IParameterChangedArgs`](../interfaces/GC.Spread.Report.IParameterChangedArgs.md) | 更改的参数值。 |
