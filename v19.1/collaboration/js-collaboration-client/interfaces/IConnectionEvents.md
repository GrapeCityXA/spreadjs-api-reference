...
- [licenseValidation](IConnectionEvents.md#licensevalidation)
...
### <a id="licensevalidation" name="licensevalidation"></a> licenseValidation

▸ **licenseValidation**(`data`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `data` | [`ILicenseValidationResult`](ILicenseValidationResult.md) |
...
| :------ | :------ |
| `data` | `unknown` |
| `type` | [`MessageType`](../Overview.md#messagetype) |
