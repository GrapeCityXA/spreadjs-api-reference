...
- [licenseKey](Server.md#licensekey)
- [serverLicenseKey](Server.md#serverlicensekey)
...
服务器的许可证密钥，用于验证和启用协作功能。

___

### <a id="serverlicensekey" name="serverlicensekey"></a> serverLicenseKey
