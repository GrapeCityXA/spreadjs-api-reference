...
- [convertFromDataTable](GC.Spread.Sheets.Tables.TableManager.md#convertfromdatatable)
- [convertToDataTable](GC.Spread.Sheets.Tables.TableManager.md#converttodatatable)
...
| `options?` | [`ITableOptions`](../interfaces/GC.Spread.Sheets.Tables.ITableOptions.md) | 表格的初始化选项。 |
...
▸ **convertFromDataTable**(`table`): [`Table`](GC.Spread.Sheets.Tables.Table.md)

将绑定数据管理器表格的表格转换为常规表格。
...
▸ **convertToDataTable**(`table`): [`Table`](GC.Spread.Sheets.Tables.Table.md)

将常规表格转换为创建并绑定数据管理器表格的表格。
