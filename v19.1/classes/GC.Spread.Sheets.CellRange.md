...
- [applyNamedCellTemplate](GC.Spread.Sheets.CellRange.md#applynamedcelltemplate)
...
| `row` | `number` | 单元格的行索引。 |
| `col` | `number` | 单元格的列索引。 |
| `rowCount?` | `number` | 单元格的行数。如果不提供此参数，则默认为 `1`。 |
| `colCount?` | `number` | 单元格的列数。如果不提供此参数，则默认为 `1`。 |
| `sheetArea?` | [`SheetArea`](../enums/GC.Spread.Sheets.SheetArea.md) | 工作表区域。如果不提供此参数，则默认为 `viewport`。 如果 row 为 -1 且 rowCount 为 -1，则范围表示列。例如，new GC.Spread.Sheets.CellRange(-1,4,-1,6) 表示列 "E:J"。 如果 col 为 -1 且 colCount 为 -1，则范围表示行。例如，new GC.Spread.Sheets.CellRange(4,-1,6,-1) 表示行 "5:10"。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 设置为 `false` 以禁止单元格进入编辑模式进行编辑。 |
...
▸ **applyNamedCellTemplate**(`name`): `void`

将命名单元格模板应用到此区域。

**`example`**
```javascript
// 按名称应用模板（该模板必须已注册到 workbook.namedCellTemplates 中）。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` \| [`IGradientFill`](../interfaces/GC.Spread.Sheets.IGradientFill.md) \| [`IGradientPathFill`](../interfaces/GC.Spread.Sheets.IGradientPathFill.md) \| [`IPatternFill`](../interfaces/GC.Spread.Sheets.IPatternFill.md) | 单元格背景颜色。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`ImageLayout`](../enums/GC.Spread.Sheets.ImageLayout.md) | 单元格背景图像布局。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 单元格底部边框线。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 单元格左侧边框线。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 单元格右侧边框线。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 单元格顶部边框线。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 单元格的斜下边框线。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 单元格的斜上边框线。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`IDropdown`](../interfaces/GC.Spread.Sheets.IDropdown.md)[] | 单元格的下拉列表。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` \| [`GeneralFormatter`](GC.Spread.Formatter.GeneralFormatter.md) | 单元格的格式化器字符串或对象。 |
...
| :------ | :------ | :------ |
| `value?` | `string` | 单元格的公式。 |
| `autoAdjustReference?` | `boolean` | 是否调整每个单元格的相对引用。如果未指定，则为 false. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`HorizontalAlign`](../enums/GC.Spread.Sheets.HorizontalAlign.md) | 水平对齐方式。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 设置为 `true` 隐藏单元格公式。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`ImeMode`](../enums/GC.Spread.Sheets.ImeMode.md) | 单元格的imeMode。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 设置为 `true` 使单元格的文本垂直。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`ILabelOptions`](../interfaces/GC.Spread.Sheets.ILabelOptions.md) | 单元格标签选项。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`IMaskType`](../interfaces/GC.Spread.Sheets.IMaskType.md) | 单元格掩码。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 设置为 `true` 使行可调整大小。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 设置为 `true` 使单元格文本显示省略号。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 设置为 `true` 使单元格缩小文本以适应。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 设置为 `true` 使用 Tab 键将焦点设置到单元格。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`TextDecorationType`](../enums/GC.Spread.Sheets.TextDecorationType.md) | 装饰类型。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`TextDirectionType`](../enums/GC.Spread.Sheets.TextDirectionType.md) | 方向类型。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `number` | 单元格文本旋转角度，从 -90 到 90 角度。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `headerOptions?` | [`HeaderOptions`](../enums/GC.Spread.Sheets.HeaderOptions.md) | 指示是否包含行标题和列标题，当单元格范围是视口区域中的整行或整列时，默认为 `noHeaders`。 |
| `includeStyle?` | `boolean` | 指示是否包含样式和跨度，默认为 `true`。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`VerticalAlign`](../enums/GC.Spread.Sheets.VerticalAlign.md) | 垂直对齐方式。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`DefaultDataValidator`](GC.Spread.Sheets.DataValidation.DefaultDataValidator.md) | 单元格数据验证器。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 设置为 `true` 允许单元格内的文本换行。 |
