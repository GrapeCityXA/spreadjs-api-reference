...
如果未设置值，则返回按钮列表是否垂直排序；否则返回复选框列表单元格类型。
...
如果未设置值，则返回布局是否自动适应；否则返回按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`IItemSpacing`](../interfaces/GC.Spread.Sheets.CellTypes.IItemSpacing.md) | 按钮列表中两个项目之间的间距。 |

#### Returns

`any`

如果未设置值，则返回按钮列表中两个项目之间的间距；否则返回按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `items?` | `string`[] \| [`ICelltypeItemOption`](../interfaces/GC.Spread.Sheets.CellTypes.ICelltypeItemOption.md)[] | 按钮列表的项目。 |

#### Returns

`any`

如果未设置值，则返回项目数组；否则返回按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `number` | 按钮列表的列数。 |

#### Returns

`any`

如果未设置值，则返回列数；否则返回按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `number` | 按钮列表的行数。 |

#### Returns

`any`

如果未设置值，则返回行数；否则返回按钮列表单元格类型。
...
获取或设置按钮列表相对于单元格的内边距（以像素为单位）。

**`example`**
```javascript
//此示例创建一个按钮列表单元格并设置其内边距。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 按钮列表相对于单元格的内边距。 |

#### Returns

`any`

如果未设置值，则返回内边距（以像素为单位）；否则返回按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 选中按钮列表的背景颜色。 |

#### Returns

`any`

如果未设置值，则返回背景颜色；否则返回按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 选中按钮列表的前景色。 |

#### Returns

`any`

如果未设置值，则返回前景色；否则返回按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`SelectionMode`](../enums/GC.Spread.Sheets.CellTypes.SelectionMode.md) | 选中按钮列表的选择模式。 |

#### Returns

`any`

如果未设置值，则返回选择模式；否则返回按钮列表单元格类型。
