...
| :------ | :------ | :------ |
| `backColor?` | `string` | 指示数据透视表样式的背景色。 |
| `foreColor?` | `string` | 指示数据透视表样式的前景色。 |
| `font?` | `string` | 指示数据透视表样式的字体。 |
| `borderLeft?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 指示数据透视表样式的左边框。 |
| `borderTop?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 指示数据透视表样式的上边框。 |
| `borderRight?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 指示数据透视表样式的右边框。 |
| `borderBottom?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 指示数据透视表样式的下边框。 |
| `borderHorizontal?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 指示数据透视表样式的水平边框。 |
| `borderVertical?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 指示数据透视表样式的垂直边框。 |
| `textDecoration?` | [`TextDecorationType`](../enums/GC.Spread.Sheets.TextDecorationType.md) | 指示数据透视表样式的文本装饰。 |
