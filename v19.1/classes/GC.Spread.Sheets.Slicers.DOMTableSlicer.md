...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 切片器的标题名称。captionName属性显示在切片器的标题栏中。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `number` | 切片器的列数。切片器的columnCount属性指定切片器内每行显示的列数。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 是否禁用切片器的调整大小和移动的设置。切片器的disableResizingAndMoving属性指定是否允许用户调整切片器控件的大小或移动它，限制对其大小或位置的任何更改。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `number` | 切片器的项目高度。切片器的itemHeight属性指定切片器内每个项目或行的高度。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 切片器的名称。该名称在工作簿中的所有切片器中必须是唯一的。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 切片器的显示标题设置。切片器的showHeader属性指定是否在切片器中显示包含标题和筛选相关控件的标题栏。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 切片器的显示无数据项目设置。切片器的showNoDataItems属性指定是否在切片器中显示在连接的透视表或数据源中没有关联数据的项目。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 切片器的最后显示无数据项目设置。切片器的showNoDataItemsInLast属性指定在呈现项目时是否将没有关联数据的项目显示在切片器列表的末尾。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`SortState`](../enums/GC.Spread.Sheets.SortState.md) | 切片器的排序状态。切片器的sortState属性指定应用于切片器内项目的当前排序状态，指示它们是否按升序或降序排序。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 无数据项目的设置。切片器的visuallyNoDataItems属性指定切片器内没有关联数据的项目的视觉表示或处理方式。 |
