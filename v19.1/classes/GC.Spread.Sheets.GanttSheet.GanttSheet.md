...
- [applyNamedCellTemplate](GC.Spread.Sheets.GanttSheet.GanttSheet.md#applynamedcelltemplate)
...
- [currentTheme](GC.Spread.Sheets.GanttSheet.GanttSheet.md#currenttheme)
...
- [getTableTheme](GC.Spread.Sheets.GanttSheet.GanttSheet.md#gettabletheme)
...
| :------ | :------ | :------ |
| `name?` | `string` | 甘特图表名称。您可以使用此名称获取甘特图表实例。 |
| `dataView?` | [`View`](GC.Data.View.md) | 用于初始化的甘特图表数据视图。 |
...
| `fieldNames` | `string`[] | 目标列，使用数据源中的字段名数组指定。 |
...
[TableSheet](GC.Spread.Sheets.TableSheet.TableSheet.md).[applyNamedCellTemplate](GC.Spread.Sheets.TableSheet.TableSheet.md#applynamedcelltemplate)
...
| `options?` | [`IGanttSheetOptions`](../modules/GC.Spread.Sheets.GanttSheet.md#iganttsheetoptions) | 甘特图表选项。 |
...
▸ **currentTheme**(`value?`): `void` \| [`Theme`](GC.Spread.Sheets.Theme.md)
...
`void` \| [`Theme`](GC.Spread.Sheets.Theme.md)

如果未设置值，则返回当前主题；否则返回工作表。

#### Inherited from

[TableSheet](GC.Spread.Sheets.TableSheet.TableSheet.md).[currentTheme](GC.Spread.Sheets.TableSheet.TableSheet.md#currenttheme)
...
### <a id="gettabletheme" name="gettabletheme"></a> getTableTheme

▸ **getTableTheme**(): [`TableTheme`](GC.Spread.Sheets.Tables.TableTheme.md)

获取 TableSheet 当前的表格主题。
...
[TableSheet](GC.Spread.Sheets.TableSheet.TableSheet.md).[getTableTheme](GC.Spread.Sheets.TableSheet.TableSheet.md#gettabletheme)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`PrintInfo`](GC.Spread.Sheets.Print.PrintInfo.md) | 表格的打印信息。 |
...
| `sheetArea?` | [`SheetArea`](../enums/GC.Spread.Sheets.SheetArea.md) | 工作表区域。 |
