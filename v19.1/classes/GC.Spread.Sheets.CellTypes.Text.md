...
[Sheets](../modules/GC.Spread.Sheets.md).[CellTypes](../modules/GC.Spread.Sheets.CellTypes.md).Text
...
- [`Base`](GC.Spread.Sheets.CellTypes.Base.md)
  ...
  ↳↳ [`DataObject`](GC.Spread.Sheets.CellTypes.DataObject.md)

  ↳↳ [`Diagonal`](GC.Spread.Sheets.CellTypes.Diagonal.md)

## Table of contents

### Constructors

- [constructor](GC.Spread.Sheets.CellTypes.Text.md#constructor)

### Properties

- [typeName](GC.Spread.Sheets.CellTypes.Text.md#typename)

### Methods

- [activateEditor](GC.Spread.Sheets.CellTypes.Text.md#activateeditor)
- [createEditorElement](GC.Spread.Sheets.CellTypes.Text.md#createeditorelement)
- [deactivateEditor](GC.Spread.Sheets.CellTypes.Text.md#deactivateeditor)
- [focus](GC.Spread.Sheets.CellTypes.Text.md#focus)
- [format](GC.Spread.Sheets.CellTypes.Text.md#format)
- [fromJSON](GC.Spread.Sheets.CellTypes.Text.md#fromjson)
- [getAutoFitHeight](GC.Spread.Sheets.CellTypes.Text.md#getautofitheight)
- [getAutoFitWidth](GC.Spread.Sheets.CellTypes.Text.md#getautofitwidth)
- [getEditorValue](GC.Spread.Sheets.CellTypes.Text.md#geteditorvalue)
- [getHitInfo](GC.Spread.Sheets.CellTypes.Text.md#gethitinfo)
- [isEditingValueChanged](GC.Spread.Sheets.CellTypes.Text.md#iseditingvaluechanged)
- [isImeAware](GC.Spread.Sheets.CellTypes.Text.md#isimeaware)
- [isReservedKey](GC.Spread.Sheets.CellTypes.Text.md#isreservedkey)
- [paint](GC.Spread.Sheets.CellTypes.Text.md#paint)
- [paintContent](GC.Spread.Sheets.CellTypes.Text.md#paintcontent)
- [parse](GC.Spread.Sheets.CellTypes.Text.md#parse)
- [processKeyDown](GC.Spread.Sheets.CellTypes.Text.md#processkeydown)
- [processKeyUp](GC.Spread.Sheets.CellTypes.Text.md#processkeyup)
- [processMouseDown](GC.Spread.Sheets.CellTypes.Text.md#processmousedown)
- [processMouseEnter](GC.Spread.Sheets.CellTypes.Text.md#processmouseenter)
- [processMouseLeave](GC.Spread.Sheets.CellTypes.Text.md#processmouseleave)
- [processMouseMove](GC.Spread.Sheets.CellTypes.Text.md#processmousemove)
- [processMouseUp](GC.Spread.Sheets.CellTypes.Text.md#processmouseup)
- [selectAll](GC.Spread.Sheets.CellTypes.Text.md#selectall)
- [setEditorValue](GC.Spread.Sheets.CellTypes.Text.md#seteditorvalue)
- [toJSON](GC.Spread.Sheets.CellTypes.Text.md#tojson)
- [updateEditor](GC.Spread.Sheets.CellTypes.Text.md#updateeditor)
- [updateEditorContainer](GC.Spread.Sheets.CellTypes.Text.md#updateeditorcontainer)
- [updateImeMode](GC.Spread.Sheets.CellTypes.Text.md#updateimemode)
...
| :------ | :------ | :------ |
| `editorType?` | [`EditorType`](../enums/GC.Spread.Sheets.CellTypes.EditorType.md) | 文本单元格类型的编辑器类型。 |
