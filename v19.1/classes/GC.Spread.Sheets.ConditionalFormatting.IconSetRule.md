...
▸ **iconCriteria**(`value?`): [`IconCriterion`](GC.Spread.Sheets.ConditionalFormatting.IconCriterion.md)[]
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`IconCriterion`](GC.Spread.Sheets.ConditionalFormatting.IconCriterion.md)[] | 图标条件集。 |

#### Returns

[`IconCriterion`](GC.Spread.Sheets.ConditionalFormatting.IconCriterion.md)[]

返回图标条件集的副本，其元素类型为 GC.Spread.Sheets.ConditionalFormatting.IconCriterion。
