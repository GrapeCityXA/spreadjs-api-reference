...
| :------ | :------ | :------ |
| `name` | `string` | 样式规则名称。 |
| `style?` | [`StyleOptions`](../modules/GC.Data.md#styleoptions) | 规则满足时的样式。 |
| `rule?` | [`FormulaRule`](../modules/GC.Data.md#formularule) \| [`StateRule`](../modules/GC.Data.md#staterule) | 样式规则选项。 |
