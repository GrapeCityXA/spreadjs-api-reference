...
- [getPageCount](GC.Spread.Report.ReportSheet.md#getpagecount)
...
**`property`** {boolean} [showHiddenRowCol] 指示是否显示隐藏的行或列。

**`property`** {GC.Spread.Sheets.Style} [hiddenRowColStyle] 此样式将在显示隐藏的行和列时用于设置标题样式。
...
### <a id="getpagecount" name="getpagecount"></a> getPageCount
...
**`deprecated`** 从19.0.0版本开始，请改用“getPageCount”
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `parameter?` | [`IParameter`](../interfaces/GC.Spread.Sheets.IParameter.md) | 设置新的参数进入报告表。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`PrintInfo`](GC.Spread.Sheets.Print.PrintInfo.md) | 报告表的打印信息。 |
