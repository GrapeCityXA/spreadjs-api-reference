...
| `options?` | [`IStatusItemOptions`](../interfaces/GC.Spread.Sheets.StatusBar.StatusItem.IStatusItemOptions.md) | 状态项选项对象。 |
...
let statusBar = new GC.Spread.Sheets.StatusBar.StatusBar(document.getElementById('gcDummyElement'));
statusBar.bind(spread);
statusBar.add(LabelItem.prototype);
```
