...
[Sheets](../modules/GC.Spread.Sheets.md).[CellTypes](../modules/GC.Spread.Sheets.CellTypes.md).RadioButtonList
...
- [constructor](GC.Spread.Sheets.CellTypes.RadioButtonList.md#constructor)

### Properties

- [typeName](GC.Spread.Sheets.CellTypes.RadioButtonList.md#typename)

### Methods

- [activateEditor](GC.Spread.Sheets.CellTypes.RadioButtonList.md#activateeditor)
- [boxSize](GC.Spread.Sheets.CellTypes.RadioButtonList.md#boxsize)
- [createEditorElement](GC.Spread.Sheets.CellTypes.RadioButtonList.md#createeditorelement)
- [deactivateEditor](GC.Spread.Sheets.CellTypes.RadioButtonList.md#deactivateeditor)
- [direction](GC.Spread.Sheets.CellTypes.RadioButtonList.md#direction)
- [focus](GC.Spread.Sheets.CellTypes.RadioButtonList.md#focus)
- [format](GC.Spread.Sheets.CellTypes.RadioButtonList.md#format)
- [fromJSON](GC.Spread.Sheets.CellTypes.RadioButtonList.md#fromjson)
- [getAutoFitHeight](GC.Spread.Sheets.CellTypes.RadioButtonList.md#getautofitheight)
- [getAutoFitWidth](GC.Spread.Sheets.CellTypes.RadioButtonList.md#getautofitwidth)
- [getEditorValue](GC.Spread.Sheets.CellTypes.RadioButtonList.md#geteditorvalue)
- [getHitInfo](GC.Spread.Sheets.CellTypes.RadioButtonList.md#gethitinfo)
- [isEditingValueChanged](GC.Spread.Sheets.CellTypes.RadioButtonList.md#iseditingvaluechanged)
- [isFlowLayout](GC.Spread.Sheets.CellTypes.RadioButtonList.md#isflowlayout)
- [isImeAware](GC.Spread.Sheets.CellTypes.RadioButtonList.md#isimeaware)
- [isReservedKey](GC.Spread.Sheets.CellTypes.RadioButtonList.md#isreservedkey)
- [itemSpacing](GC.Spread.Sheets.CellTypes.RadioButtonList.md#itemspacing)
- [items](GC.Spread.Sheets.CellTypes.RadioButtonList.md#items)
- [maxColumnCount](GC.Spread.Sheets.CellTypes.RadioButtonList.md#maxcolumncount)
- [maxRowCount](GC.Spread.Sheets.CellTypes.RadioButtonList.md#maxrowcount)
- [paint](GC.Spread.Sheets.CellTypes.RadioButtonList.md#paint)
- [paintContent](GC.Spread.Sheets.CellTypes.RadioButtonList.md#paintcontent)
- [parse](GC.Spread.Sheets.CellTypes.RadioButtonList.md#parse)
- [processKeyDown](GC.Spread.Sheets.CellTypes.RadioButtonList.md#processkeydown)
- [processKeyUp](GC.Spread.Sheets.CellTypes.RadioButtonList.md#processkeyup)
- [processMouseDown](GC.Spread.Sheets.CellTypes.RadioButtonList.md#processmousedown)
- [processMouseEnter](GC.Spread.Sheets.CellTypes.RadioButtonList.md#processmouseenter)
- [processMouseLeave](GC.Spread.Sheets.CellTypes.RadioButtonList.md#processmouseleave)
- [processMouseMove](GC.Spread.Sheets.CellTypes.RadioButtonList.md#processmousemove)
- [processMouseUp](GC.Spread.Sheets.CellTypes.RadioButtonList.md#processmouseup)
- [selectAll](GC.Spread.Sheets.CellTypes.RadioButtonList.md#selectall)
- [setEditorValue](GC.Spread.Sheets.CellTypes.RadioButtonList.md#seteditorvalue)
- [textAlign](GC.Spread.Sheets.CellTypes.RadioButtonList.md#textalign)
- [toJSON](GC.Spread.Sheets.CellTypes.RadioButtonList.md#tojson)
- [updateEditor](GC.Spread.Sheets.CellTypes.RadioButtonList.md#updateeditor)
- [updateEditorContainer](GC.Spread.Sheets.CellTypes.RadioButtonList.md#updateeditorcontainer)
- [updateImeMode](GC.Spread.Sheets.CellTypes.RadioButtonList.md#updateimemode)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` \| `number` | 单选按钮的大小。如果值为"auto"，则单选按钮的大小将随字体大小变化。 |

#### Returns

`any`

如果未设置值，则返回单选按钮的大小；否则返回单选按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`Direction`](../enums/GC.Spread.Sheets.CellTypes.Direction.md) | 是否垂直排序。 |

#### Returns

`any`

如果未设置值，则返回单选按钮列表是否垂直排序；否则返回单选按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 布局是否自动适应。 |

#### Returns

`any`

如果未设置值，则返回布局是否自动适应；否则返回单选按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`IItemSpacing`](../interfaces/GC.Spread.Sheets.CellTypes.IItemSpacing.md) | 单选按钮列表中两个选项之间的间距。 |

#### Returns

`any`

如果未设置值，则返回选项之间的间距；否则返回单选按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `items?` | `string`[] \| [`ICelltypeItemOption`](../interfaces/GC.Spread.Sheets.CellTypes.ICelltypeItemOption.md)[] | 单选按钮列表的选项。 |

#### Returns

`any`

如果未设置值，则返回选项数组；否则返回单选按钮列表单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`TextAlign`](../enums/GC.Spread.Sheets.CellTypes.TextAlign.md) | 单选按钮文本的位置。 |

#### Returns

`any`

如果未设置值，则返回文本位置；否则返回单选按钮列表单元格类型。
