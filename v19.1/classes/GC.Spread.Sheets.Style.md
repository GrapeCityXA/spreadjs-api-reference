...
| :------ | :------ | :------ |
| `backColor?` | `string` \| [`IGradientFill`](../interfaces/GC.Spread.Sheets.IGradientFill.md) \| [`IGradientPathFill`](../interfaces/GC.Spread.Sheets.IGradientPathFill.md) \| [`IPatternFill`](../interfaces/GC.Spread.Sheets.IPatternFill.md) | 背景颜色。 |
| `foreColor?` | `string` | 前景颜色。 |
| `hAlign?` | [`HorizontalAlign`](../enums/GC.Spread.Sheets.HorizontalAlign.md) | 水平对齐方式。 |
| `vAlign?` | [`VerticalAlign`](../enums/GC.Spread.Sheets.VerticalAlign.md) | 垂直对齐方式。 |
| `font?` | `string` | 字体。 |
| `themeFont?` | `string` | 字体主题。 |
...
| `wordWrap?` | `boolean` | 文本是否在单元格内自动换行。 |
...
| `backgroundImageLayout?` | [`ImageLayout`](../enums/GC.Spread.Sheets.ImageLayout.md) | 背景图片的布局。 |
| `tabStop?` | `boolean` | 用户是否可以使用Tab键将焦点设置到单元格。 |
| `textDecoration?` | [`TextDecorationType`](../enums/GC.Spread.Sheets.TextDecorationType.md) | 指定添加到文本的装饰。 |
| `imeMode?` | [`ImeMode`](../enums/GC.Spread.Sheets.ImeMode.md) | 指定输入法编辑器模式。 |
| `name?` | `string` | 指定名称。 |
| `parentName?` | `string` | 指定父样式的名称。 |
| `watermark?` | `string` | 指定水印内容。 |
| `cellPadding?` | `string` | 指定单元格内边距。 |
| `labelOptions?` | [`ILabelOptions`](../interfaces/GC.Spread.Sheets.ILabelOptions.md) | 指定单元格标签选项。 |
| `quotePrefix?` | `boolean` | - |
| `diagonalDown?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 从左上到右下的对角线。 |
| `diagonalUp?` | [`LineBorder`](GC.Spread.Sheets.LineBorder.md) | 从右上到左下的对角线。 |
...
| `fontStyle?` | `string` | 指定字体样式。 |
| `fontWeight?` | `string` | 指定字体粗细。 |
| `fontSize?` | `string` | 指定字体大小。 |
| `fontFamily?` | `string` | 指定字体系列。 |
| `hidden?` | `boolean` | - |
| `textDirection?` | [`TextDirectionType`](../enums/GC.Spread.Sheets.TextDirectionType.md) | 指定文本方向。 |
