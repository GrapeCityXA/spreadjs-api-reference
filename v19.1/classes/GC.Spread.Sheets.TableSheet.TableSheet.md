...
- [applyNamedCellTemplate](GC.Spread.Sheets.TableSheet.TableSheet.md#applynamedcelltemplate)
...
- [currentTheme](GC.Spread.Sheets.TableSheet.TableSheet.md#currenttheme)
...
- [getTableTheme](GC.Spread.Sheets.TableSheet.TableSheet.md#gettabletheme)
...
| :------ | :------ | :------ |
| `name?` | `string` | 计算表名称。 |
| `dataView?` | [`View`](GC.Data.View.md) | 计算表数据视图。 |
| `options?` | [`ITableSheetOptions`](../interfaces/GC.Spread.Sheets.TableSheet.ITableSheetOptions.md) | 初始化选项。 |
