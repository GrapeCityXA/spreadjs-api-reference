...
- [hitTestMode](GC.Spread.Sheets.CellTypes.CheckBox.md#hittestmode)
...
- [mode](GC.Spread.Sheets.CellTypes.CheckBox.md#mode)
...
- [textEditable](GC.Spread.Sheets.CellTypes.CheckBox.md#texteditable)
...
- [toggleOptions](GC.Spread.Sheets.CellTypes.CheckBox.md#toggleoptions)
...
### <a id="hittestmode" name="hittestmode"></a> hitTestMode

▸ **hitTestMode**(`value?`): [`CheckBox`](GC.Spread.Sheets.CellTypes.CheckBox.md) \| [`CheckBoxHitTestMode`](../modules/GC.Spread.Sheets.CellTypes.md#checkboxhittestmode)

获取或设置一个值，该值指示复选框单元格类型在 checkbox 和 modern 模式下的命中测试模式。
该设置用于控制单元格的哪个区域会响应鼠标交互（点击、光标变化）。

**`example`**
```javascript
// 此示例创建一个使用 checkbox 模式命中测试的复选框单元格。
var cellType1 = new GC.Spread.Sheets.CellTypes.CheckBox();
cellType1.textTrue("Yes");
cellType1.textFalse("No");
cellType1.hitTestMode("checkbox"); // 只有复选框区域响应点击
activeSheet.getCell(1, 1).cellType(cellType1);
```

**`example`**
```javascript
// 此示例创建一个使用 cell 模式命中测试的复选框单元格（默认）。
var cellType2 = new GC.Spread.Sheets.CellTypes.CheckBox();
cellType2.textTrue("Checked");
cellType2.textFalse("Unchecked");
cellType2.hitTestMode("cell"); // 整个单元格区域都响应点击
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`CheckBoxHitTestMode`](../modules/GC.Spread.Sheets.CellTypes.md#checkboxhittestmode) | 命中测试模式。'cell' 表示整个单元格区域响应交互；'checkbox' 表示只有复选框区域响应交互。 |

#### Returns

[`CheckBox`](GC.Spread.Sheets.CellTypes.CheckBox.md) \| [`CheckBoxHitTestMode`](../modules/GC.Spread.Sheets.CellTypes.md#checkboxhittestmode)

如果未设置值，则返回复选框单元格类型的命中测试模式；否则返回复选框单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 是否支持三态。 |

#### Returns

`any`

如果未设置值，则返回是否支持三态；否则返回复选框单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`CheckBoxMode`](../modules/GC.Spread.Sheets.CellTypes.md#checkboxmode) | 复选框单元格类型的模式。 |

#### Returns

`any`

如果未设置值，则返回复选框单元格类型的模式。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`CheckBoxTextAlign`](../enums/GC.Spread.Sheets.CellTypes.CheckBoxTextAlign.md) | 文本相对于复选框的对齐方式。 |

#### Returns

`any`

如果未设置值，则返回文本相对于复选框的对齐方式；否则返回复选框单元格类型。

___

### <a id="texteditable" name="texteditable"></a> textEditable

▸ **textEditable**(`value?`): `boolean` \| [`CheckBox`](GC.Spread.Sheets.CellTypes.CheckBox.md)

获取或设置一个值，该值指示复选框单元格类型在 checkbox 和 modern 模式下是否允许编辑文本。
设置为 false 时，复选框会表现为切换模式，且无法进入文本编辑模式（双击或按 F2）。

**`example`**
```javascript
// 此示例创建一个文本不可编辑的复选框单元格。
var cellType1 = new GC.Spread.Sheets.CellTypes.CheckBox();
cellType1.textTrue("Yes");
cellType1.textFalse("No");
cellType1.textEditable(false); // 无法通过双击编辑文本
activeSheet.getCell(1, 1).cellType(cellType1);
```

**`example`**
```javascript
// 此示例创建一个文本可编辑的复选框单元格（默认）。
var cellType2 = new GC.Spread.Sheets.CellTypes.CheckBox();
cellType2.textTrue("Checked");
cellType2.textFalse("Unchecked");
cellType2.textEditable(true); // 可以通过双击编辑文本
activeSheet.getCell(2, 1).cellType(cellType2);
```
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 复选框文本是否可编辑。默认值为 true。 |

#### Returns

`boolean` \| [`CheckBox`](GC.Spread.Sheets.CellTypes.CheckBox.md)

如果未设置值，则返回复选框文本是否可编辑；否则返回复选框单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 单元格的值为`false`时的文本。 |

#### Returns

`any`

如果未设置值，则返回单元格的值为`false`时的文本；否则返回复选框单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 单元格的值为不确定时的文本。 |

#### Returns

`any`

如果未设置值，则返回单元格的值为不确定时的文本；否则返回复选框单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 单元格的值为`true`时的文本。 |

#### Returns

`any`

如果未设置值，则返回单元格的值为`true`时的文本；否则返回复选框单元格类型。
