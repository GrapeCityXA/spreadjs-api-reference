...
| `borderStyle` | [`SlicerBorderStyle`](../modules/GC.Spread.Sheets.Slicers.md#slicerborderstyle) | 边框样式。 |
...
console.log(border.borderColor()); // green
border.borderColor('red');
console.log(border.borderColor()); // red
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`SlicerBorderStyle`](../modules/GC.Spread.Sheets.Slicers.md#slicerborderstyle) | 边框样式。 <br/> |

#### Returns

`any`

如果未设置值，返回边框样式；否则返回切片器边框。
