...
[Sheets](../modules/GC.Spread.Sheets.md).[Filter](../modules/GC.Spread.Sheets.Filter.md).HideRowFilter
...
- [constructor](GC.Spread.Sheets.Filter.HideRowFilter.md#constructor)

### Properties

- [extendedRange](GC.Spread.Sheets.Filter.HideRowFilter.md#extendedrange)
- [range](GC.Spread.Sheets.Filter.HideRowFilter.md#range)
- [typeName](GC.Spread.Sheets.Filter.HideRowFilter.md#typename)

### Methods

- [addFilterItem](GC.Spread.Sheets.Filter.HideRowFilter.md#addfilteritem)
- [filter](GC.Spread.Sheets.Filter.HideRowFilter.md#filter)
- [filterButtonVisible](GC.Spread.Sheets.Filter.HideRowFilter.md#filterbuttonvisible)
- [filterDialogVisibleInfo](GC.Spread.Sheets.Filter.HideRowFilter.md#filterdialogvisibleinfo)
- [fromJSON](GC.Spread.Sheets.Filter.HideRowFilter.md#fromjson)
- [getFilterItems](GC.Spread.Sheets.Filter.HideRowFilter.md#getfilteritems)
- [getFilteredItems](GC.Spread.Sheets.Filter.HideRowFilter.md#getfiltereditems)
- [getSortState](GC.Spread.Sheets.Filter.HideRowFilter.md#getsortstate)
- [isFiltered](GC.Spread.Sheets.Filter.HideRowFilter.md#isfiltered)
- [isRowFilteredOut](GC.Spread.Sheets.Filter.HideRowFilter.md#isrowfilteredout)
- [onFilter](GC.Spread.Sheets.Filter.HideRowFilter.md#onfilter)
- [openFilterDialog](GC.Spread.Sheets.Filter.HideRowFilter.md#openfilterdialog)
- [removeFilterItems](GC.Spread.Sheets.Filter.HideRowFilter.md#removefilteritems)
- [reset](GC.Spread.Sheets.Filter.HideRowFilter.md#reset)
- [sortColumn](GC.Spread.Sheets.Filter.HideRowFilter.md#sortcolumn)
- [toJSON](GC.Spread.Sheets.Filter.HideRowFilter.md#tojson)
- [unfilter](GC.Spread.Sheets.Filter.HideRowFilter.md#unfilter)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[constructor](GC.Spread.Sheets.Filter.RowFilterBase.md#constructor)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[extendedRange](GC.Spread.Sheets.Filter.RowFilterBase.md#extendedrange)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[range](GC.Spread.Sheets.Filter.RowFilterBase.md#range)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[typeName](GC.Spread.Sheets.Filter.RowFilterBase.md#typename)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[addFilterItem](GC.Spread.Sheets.Filter.RowFilterBase.md#addfilteritem)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[filter](GC.Spread.Sheets.Filter.RowFilterBase.md#filter)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[filterButtonVisible](GC.Spread.Sheets.Filter.RowFilterBase.md#filterbuttonvisible)

___

### <a id="filterdialogvisibleinfo" name="filterdialogvisibleinfo"></a> filterDialogVisibleInfo
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `visibleInfo?` | [`IFilterDialogVisibleInfo`](../interfaces/GC.Spread.Sheets.Filter.IFilterDialogVisibleInfo.md) | 行筛选器的可见信息。 |

#### Returns

`any`

如果未设置值，则返回筛选对话框可见信息；否则返回HideRowFilter。
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[fromJSON](GC.Spread.Sheets.Filter.RowFilterBase.md#fromjson)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[getFilterItems](GC.Spread.Sheets.Filter.RowFilterBase.md#getfilteritems)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[getFilteredItems](GC.Spread.Sheets.Filter.RowFilterBase.md#getfiltereditems)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[getSortState](GC.Spread.Sheets.Filter.RowFilterBase.md#getsortstate)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[isFiltered](GC.Spread.Sheets.Filter.RowFilterBase.md#isfiltered)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[isRowFilteredOut](GC.Spread.Sheets.Filter.RowFilterBase.md#isrowfilteredout)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[onFilter](GC.Spread.Sheets.Filter.RowFilterBase.md#onfilter)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[openFilterDialog](GC.Spread.Sheets.Filter.RowFilterBase.md#openfilterdialog)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[removeFilterItems](GC.Spread.Sheets.Filter.RowFilterBase.md#removefilteritems)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[reset](GC.Spread.Sheets.Filter.RowFilterBase.md#reset)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[sortColumn](GC.Spread.Sheets.Filter.RowFilterBase.md#sortcolumn)
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[toJSON](GC.Spread.Sheets.Filter.RowFilterBase.md#tojson)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `col?` | `number` | 要移除筛选的列索引；如果省略，则移除范围内所有列的筛选。 |
...
[RowFilterBase](GC.Spread.Sheets.Filter.RowFilterBase.md).[unfilter](GC.Spread.Sheets.Filter.RowFilterBase.md#unfilter)
