...
[Sheets](../modules/GC.Spread.Sheets.md).[CellTypes](../modules/GC.Spread.Sheets.CellTypes.md).RangeTemplate
...
- [constructor](GC.Spread.Sheets.CellTypes.RangeTemplate.md#constructor)

### Properties

- [typeName](GC.Spread.Sheets.CellTypes.RangeTemplate.md#typename)

### Methods

- [activateEditor](GC.Spread.Sheets.CellTypes.RangeTemplate.md#activateeditor)
- [createEditorElement](GC.Spread.Sheets.CellTypes.RangeTemplate.md#createeditorelement)
- [deactivateEditor](GC.Spread.Sheets.CellTypes.RangeTemplate.md#deactivateeditor)
- [focus](GC.Spread.Sheets.CellTypes.RangeTemplate.md#focus)
- [format](GC.Spread.Sheets.CellTypes.RangeTemplate.md#format)
- [fromJSON](GC.Spread.Sheets.CellTypes.RangeTemplate.md#fromjson)
- [getAutoFitHeight](GC.Spread.Sheets.CellTypes.RangeTemplate.md#getautofitheight)
- [getAutoFitWidth](GC.Spread.Sheets.CellTypes.RangeTemplate.md#getautofitwidth)
- [getEditorValue](GC.Spread.Sheets.CellTypes.RangeTemplate.md#geteditorvalue)
- [getHitInfo](GC.Spread.Sheets.CellTypes.RangeTemplate.md#gethitinfo)
- [isEditingValueChanged](GC.Spread.Sheets.CellTypes.RangeTemplate.md#iseditingvaluechanged)
- [isImeAware](GC.Spread.Sheets.CellTypes.RangeTemplate.md#isimeaware)
- [isReservedKey](GC.Spread.Sheets.CellTypes.RangeTemplate.md#isreservedkey)
- [paint](GC.Spread.Sheets.CellTypes.RangeTemplate.md#paint)
- [paintContent](GC.Spread.Sheets.CellTypes.RangeTemplate.md#paintcontent)
- [parse](GC.Spread.Sheets.CellTypes.RangeTemplate.md#parse)
- [processKeyDown](GC.Spread.Sheets.CellTypes.RangeTemplate.md#processkeydown)
- [processKeyUp](GC.Spread.Sheets.CellTypes.RangeTemplate.md#processkeyup)
- [processMouseDown](GC.Spread.Sheets.CellTypes.RangeTemplate.md#processmousedown)
- [processMouseEnter](GC.Spread.Sheets.CellTypes.RangeTemplate.md#processmouseenter)
- [processMouseLeave](GC.Spread.Sheets.CellTypes.RangeTemplate.md#processmouseleave)
- [processMouseMove](GC.Spread.Sheets.CellTypes.RangeTemplate.md#processmousemove)
- [processMouseUp](GC.Spread.Sheets.CellTypes.RangeTemplate.md#processmouseup)
- [selectAll](GC.Spread.Sheets.CellTypes.RangeTemplate.md#selectall)
- [setEditorValue](GC.Spread.Sheets.CellTypes.RangeTemplate.md#seteditorvalue)
- [toJSON](GC.Spread.Sheets.CellTypes.RangeTemplate.md#tojson)
- [updateEditor](GC.Spread.Sheets.CellTypes.RangeTemplate.md#updateeditor)
- [updateEditorContainer](GC.Spread.Sheets.CellTypes.RangeTemplate.md#updateeditorcontainer)
- [updateImeMode](GC.Spread.Sheets.CellTypes.RangeTemplate.md#updateimemode)

## Constructors

### <a id="constructor" name="constructor"></a> constructor

• **new RangeTemplate**(`sheet`, `row?`, `col?`, `rowCount?`, `colCount?`)

**`description`** RangeTemplate 提供来自引用工作表范围的模板，可以应用于单元格。它将使单元格的渲染与模板相同，但填充不同的数据。如果未设置参数 row、col、rowCount、colCount，则将使用整个工作表作为范围。
...
| :------ | :------ | :------ |
| `sheet` | [`Worksheet`](GC.Spread.Sheets.Worksheet.md) | 引用的工作表，该工作表可以是工作簿之外的独立工作表。 |
| `row?` | `number` | 模板范围的起始行。 |
| `col?` | `number` | 模板范围的起始列。 |
| `rowCount?` | `number` | 模板范围的行数。 |
| `colCount?` | `number` | 模板范围的列数。 |
