...
| `width?` | `number` | 可选参数。图片形状的宽度，留空则默认与图片的原始宽度一致。 |
| `height?` | `number` | 可选参数。图片形状的高度，留空则默认与图片的原始高度一致。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`AutoShapeType`](../enums/GC.Spread.Sheets.Shapes.AutoShapeType.md) | 图片的几何类型。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`IPictureFormat`](../interfaces/GC.Spread.Sheets.Shapes.IPictureFormat.md) | 图片的格式。 |
