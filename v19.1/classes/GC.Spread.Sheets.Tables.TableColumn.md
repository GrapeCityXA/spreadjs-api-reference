...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`Base`](GC.Spread.Sheets.CellTypes.Base.md) | 表格列单元格类型。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` \| [`Style`](GC.Spread.Sheets.Style.md) | 表格列数据样式。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` \| [`Style`](GC.Spread.Sheets.Style.md) | 表格列页脚样式。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` \| [`Style`](GC.Spread.Sheets.Style.md) | 表格列的表头样式。 |
