...
| `row?` | `number` | 行索引。 |
| `column?` | `number` | 列索引。 |
| `dataReference?` | [`Range`](GC.Spread.Sheets.Range.md) | 迷你图引用的数据范围。 |
| `dataOrientation?` | [`DataOrientation`](../enums/GC.Spread.Sheets.Sparklines.DataOrientation.md) | 数据范围的方向。 |
...
| Name | Type |
| :------ | :------ |
| `value?` | [`SparklineGroup`](GC.Spread.Sheets.Sparklines.SparklineGroup.md) |

#### Returns

`any`

如果未设置值，则返回迷你图组；否则返回迷你图。
...
sparkline.paintSparkline(ctx, 0, 0, 200, 200);
```
...
| `w` | `number` | 包含迷你图的单元格宽度。 |
| `h` | `number` | 包含迷你图的单元格高度。 |
...
| Name | Type |
| :------ | :------ |
| `value?` | [`SparklineSetting`](GC.Spread.Sheets.Sparklines.SparklineSetting.md) |

#### Returns

`any`

如果未设置值，则返回迷你图设置；否则返回迷你图。
...
| Name | Type |
| :------ | :------ |
| `value?` | [`SparklineType`](../enums/GC.Spread.Sheets.Sparklines.SparklineType.md) |

#### Returns

`any`

如果未设置值，则返回迷你图类型；否则返回迷你图。
