...
**`param`** *[GC.Spread.Common.IUser](../interfaces/GC.Spread.Common.IUser.md)* `oldCurrentUser` 旧的当前用户。

**`param`** *[GC.Spread.Common.IUser](../interfaces/GC.Spread.Common.IUser.md)* `newCurrentUser` 新的当前用户。
