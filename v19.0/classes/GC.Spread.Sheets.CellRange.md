...
option: { items: [{text: 'item1',value: 'item1'}, {text: 'item2',value: 'item2'}, {text: 'item3',value: 'item3'}, {text: 'item4',value: 'item4'}],}
}
]
activeSheet.getRange(2,-1, 1, -1, GC.Spread.Sheets.SheetArea.viewport).dropDowns(value);
```
