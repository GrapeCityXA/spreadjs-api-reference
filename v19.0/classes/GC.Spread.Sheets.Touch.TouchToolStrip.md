...
| Name | Type | Description |
| :------ | :------ | :------ |
| `item` | [`TouchToolStripSeparator`](GC.Spread.Sheets.Touch.TouchToolStripSeparator.md) \| [`TouchToolStripItem`](GC.Spread.Sheets.Touch.TouchToolStripItem.md) | 要添加的项目。 |
...
spread.touchToolStrip.itemWidth(50);
spread.touchToolStrip.add(new GC.Spread.Sheets.Touch.TouchToolStripSeparator());
spread.touchToolStrip.open(0, 0);
...
如果项目存在于工具栏中，则返回该项目；否则返回undefined。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `height?` | `number` | 图像区域高度。 |

#### Returns

`any`

如果未设置值，则返回图像区域高度；否则返回工具栏。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `height?` | `number` | 工具栏项目高度。 |

#### Returns

`any`

如果未设置值，则返回工具栏项目高度；否则返回工具栏。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `width?` | `number` | 工具栏项目宽度。 |

#### Returns

`any`

如果未设置值，则返回工具栏项目宽度；否则返回工具栏。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `height?` | `number` | 工具栏分隔符高度。 |

#### Returns

`any`

如果未设置值，则返回工具栏分隔符高度；否则返回工具栏。
