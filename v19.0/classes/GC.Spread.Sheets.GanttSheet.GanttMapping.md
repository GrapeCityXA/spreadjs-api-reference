...
一个辅助函数，用于将 [GC.Spread.Sheets.GanttSheet.Duration](../modules/GC.Spread.Sheets.GanttSheet.md#duration) 值格式化为字符串。
...
一个辅助函数，用于将 [GC.Spread.Sheets.GanttSheet.TaskScheduleMode](../modules/GC.Spread.Sheets.GanttSheet.md#taskschedulemode) 值格式化为字符串。
...
一个辅助函数，用于将字符串或其他类型的原始值解析为 [GC.Spread.Sheets.GanttSheet.Duration](../modules/GC.Spread.Sheets.GanttSheet.md#duration) 值。
...
一个辅助函数，用于将字符串或其他类型的原始值解析为 [GC.Spread.Sheets.GanttSheet.TaskScheduleMode](../modules/GC.Spread.Sheets.GanttSheet.md#taskschedulemode) 值。
