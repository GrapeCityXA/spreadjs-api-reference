...
- [backgroundImage](GC.Spread.Sheets.IWorksheetOptions.md#backgroundimage)
...
用于表示冻结线颜色的颜色字符串，如"red"、"#FFFF00"、"rgb(255,0,0)"、"Accent 5"等。
