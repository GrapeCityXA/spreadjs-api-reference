...
| Name | Type | Description |
| :------ | :------ | :------ |
| `K` | extends keyof [`IHookContext`](../interfaces/IHookContext.md) | 操作名称的类型，扩展 keyof IHookContext。 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `K` | extends keyof [`IMiddlewareContext`](../interfaces/IMiddlewareContext.md) | 操作名称的类型，扩展 keyof IMiddlewareContext。 |
