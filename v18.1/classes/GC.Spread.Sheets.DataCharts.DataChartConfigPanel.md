...
| :------ | :------ | :------ |
| `host` | `string` \| `HTMLElement` | 宿主元素或宿主元素ID或宿主元素选择器。 |
| `spread` | [`Workbook`](GC.Spread.Sheets.Workbook.md) | 面板所附加的电子表格。 |
...
通过宿主元素获取DataChartConfigPanel实例。
