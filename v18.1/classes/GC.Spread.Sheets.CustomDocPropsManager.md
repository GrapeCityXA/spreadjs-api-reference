...
| `value` | [`CustomDocumentPropertyValueType`](../modules/GC.Spread.Sheets.md#customdocumentpropertyvaluetype) | 属性值。 |
| `isLinkTarget?` | `boolean` | 是否为内容链接。 |
