...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 按钮的背景颜色。 |

#### Returns

`any`

如果未设置值，则返回背景颜色；否则返回按钮单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `number` | 按钮相对于单元格的底部边距。 |

#### Returns

`any`

如果未设置值，则返回底部边距（以像素为单位）；否则返回按钮单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `number` | 按钮相对于单元格的左侧边距。 |

#### Returns

`any`

如果未设置值，则返回左侧边距（以像素为单位）；否则返回按钮单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `number` | 按钮相对于单元格的右侧边距。 |

#### Returns

`any`

如果未设置值，则返回右侧边距（以像素为单位）；否则返回按钮单元格类型。
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `number` | 按钮相对于单元格的顶部边距。 |

#### Returns

`any`

如果未设置值，则返回顶部边距（以像素为单位）；否则返回按钮单元格类型。
