...
**`param`** *[GC.Spread.Sheets.Worksheet](GC.Spread.Sheets.Worksheet.md)* `oldSheet` 旧工作表。

**`param`** *[GC.Spread.Sheets.Worksheet](GC.Spread.Sheets.Worksheet.md)* `newSheet` 新工作表。
...
**`param`** *[GC.Spread.Sheets.Worksheet](GC.Spread.Sheets.Worksheet.md)* `sheet` 触发事件的工作表。
...
**`param`** *[GC.Spread.Sheets.SheetArea](../enums/GC.Spread.Sheets.SheetArea.md)* `sheetArea` 包含单元格的工作表区域。
...
**`param`** *[GC.Spread.Sheets.SheetArea](../enums/GC.Spread.Sheets.SheetArea.md)* `sheetArea` 单元格的工作表区域。
...
**`param`** *[GC.Spread.Sheets.SheetArea](../enums/GC.Spread.Sheets.SheetArea.md)* `sheetArea` 被点击单元格所在的工作表区域。
...
**`param`** *[GC.Spread.Sheets.ClipboardActionType](../enums/GC.Spread.Sheets.ClipboardActionType.md)* `action` 指示当前操作的类型。
...
**`param`** *[GC.Spread.Sheets.Range](GC.Spread.Sheets.Range.md)* `cellRange` 被粘贴的范围。

**`param`** *[GC.Spread.Sheets.ClipboardPasteOptions](../enums/GC.Spread.Sheets.ClipboardPasteOptions.md)* `pasteOption` 指示从剪贴板粘贴的数据类型：值、格式或公式。
...
**`param`** *[GC.Spread.Sheets.Worksheet](GC.Spread.Sheets.Worksheet.md)* `fromSheet` 数据范围的源工作表。

**`param`** *[GC.Spread.Sheets.Range](GC.Spread.Sheets.Range.md)* `[fromRange]` 复制或剪切范围时粘贴的源范围。

**`param`** *[GC.Spread.Sheets.ClipboardActionType](../enums/GC.Spread.Sheets.ClipboardActionType.md)* `action` 指示当前操作的类型。

**`param`** *Array* `objects` 粘贴的浮动对象，包含图片、自定义浮动对象、切片器、图表和形状。

**`param`** *[GC.Spread.Sheets.InsertShiftCell](../enums/GC.Spread.Sheets.InsertShiftCell.md)* `[shiftCells]` 如果未移动单元格，则将未定义。
...
**`param`** *[GC.Spread.Sheets.Range](GC.Spread.Sheets.Range.md)* `cellRange` 要粘贴的范围。
...
**`param`** *[GC.Spread.Sheets.SheetArea](../enums/GC.Spread.Sheets.SheetArea.md)* `sheetArea` 列的工作表区域。
...
**`param`** *[GC.Spread.Sheets.Comments.Comment](GC.Spread.Sheets.Comments.Comment.md)* `comment` 触发事件的注释。
...
**`param`** *[GC.Spread.Sheets.Comments.Comment](GC.Spread.Sheets.Comments.Comment.md)* `comment` 已删除的注释。
...
**`param`** *[GC.Spread.Sheets.Comments.Comment](GC.Spread.Sheets.Comments.Comment.md)* `comment` 正在删除的注释。
...
**`param`** *[GC.Spread.Sheets.Workbook](GC.Spread.Sheets.Workbook.md)* `spread` 触发事件的工作簿。
...
**`param`** *[GC.Spread.Sheets.CopyToOptions](../enums/GC.Spread.Sheets.CopyToOptions.md)* `copyOption` 拖放操作的CopyOption值。
...
**`param`** *[GC.Spread.Sheets.Range](GC.Spread.Sheets.Range.md)* `fillRange` 用于填充操作的范围。
...
**`param`** *[GC.Spread.Sheets.Range](GC.Spread.Sheets.Range.md)* `mergeRange` 将要合并的范围。
...
**`param`** *[GC.Spread.Sheets.EditorStatus](../enums/GC.Spread.Sheets.EditorStatus.md)* `oldStatus` 编辑器的旧状态。

**`param`** *[GC.Spread.Sheets.EditorStatus](../enums/GC.Spread.Sheets.EditorStatus.md)* `newStatus` 编辑器的新状态。
...
**`param`** *[GC.Spread.Sheets.FloatingObjects.FloatingObject](GC.Spread.Sheets.FloatingObjects.FloatingObject.md)* `floatingObject` 已被移除的浮动对象。
...
**`param`** *[GC.Spread.Sheets.FloatingObjects.FloatingObject](GC.Spread.Sheets.FloatingObjects.FloatingObject.md)* `floatingObject` 正在被移除的浮动对象。
...
**`param`** *[GC.Spread.Sheets.InvalidOperationType](../enums/GC.Spread.Sheets.InvalidOperationType.md)* `invalidType` 指示哪个操作无效。

**`param`** *string* `message` 无效操作的描述。

**`param`** *[GC.Spread.Sheets.Range](GC.Spread.Sheets.Range.md)* `[fillRange]` 当invalidType为dragFill时，用于填充操作的范围。
...
**`param`** *[GC.Spread.Sheets.Range](GC.Spread.Sheets.Range.md)* `range` 自动排序的范围。

**`param`** *[GC.Spread.Sheets.GroupSort](../enums/GC.Spread.Sheets.GroupSort.md)* `groupSort` 排序时使用的groupSort级别，默认情况下如果包含组则使用组级别，如果不包含组则使用平面级别。
...
**`param`** *[GC.Spread.Sheets.SheetArea](../enums/GC.Spread.Sheets.SheetArea.md)* `sheetArea` 行所在的工作表区域。
...
**`param`** *[GC.Spread.Sheets.TableSheet.TableSheet](GC.Spread.Sheets.TableSheet.TableSheet.md)* `sheet` 触发事件的计算表。
...
**`param`** *[GC.Spread.Sheets.Shapes.Shape](GC.Spread.Sheets.Shapes.Shape.md)* `shape` 已被移除的形状。
...
**`param`** *[GC.Spread.Sheets.Shapes.Shape](GC.Spread.Sheets.Shapes.Shape.md)* `shape` 正在被移除的形状。
...
**`param`** *[GC.Spread.Sheets.Sparklines.Sparkline](GC.Spread.Sheets.Sparklines.Sparkline.md)* `sparkline` 属性已更改的迷你图。
...
**`param`** *[GC.Spread.Sheets.Tables.Table](GC.Spread.Sheets.Tables.Table.md)* `table` 插入/删除行的表格。
...
**`param`** *[GC.Spread.Sheets.Tables.Table](GC.Spread.Sheets.Tables.Table.md)* `table` 要自动筛选的表格列。
...
**`param`** *[GC.Spread.Sheets.Tables.Table](GC.Spread.Sheets.Tables.Table.md)* `table` 被调整大小的表格。

**`param`** *[GC.Spread.Sheets.Range](GC.Spread.Sheets.Range.md)* `oldRange` 调整前的表格范围。

**`param`** *[GC.Spread.Sheets.Range](GC.Spread.Sheets.Range.md)* `newRange` 调整后的表格范围。
...
**`param`** *[GC.Spread.Sheets.Tables.Table](GC.Spread.Sheets.Tables.Table.md)* `table` 正在调整大小的表格。
...
**`param`** *[GC.Spread.Sheets.DataValidation.DataValidationResult](../enums/GC.Spread.Sheets.DataValidation.DataValidationResult.md)* `validationResult` 用户可以设置的处理错误的策略。
