...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`Direction`](../enums/GC.Spread.Sheets.CellTypes.Direction.md) | 顺序是垂直的 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`IItemSpacing`](../interfaces/GC.Spread.Sheets.CellTypes.IItemSpacing.md) | 单选按钮列表中两个项的空间 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `items?` | `string`[] \| [`ICelltypeItemOption`](../interfaces/GC.Spread.Sheets.CellTypes.ICelltypeItemOption.md)[] | 单选按钮列表的项 |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`TextAlign`](../enums/GC.Spread.Sheets.CellTypes.TextAlign.md) | 单选按钮位置的文本 |
