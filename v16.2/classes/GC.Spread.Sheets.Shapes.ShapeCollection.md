...
| `name` | `string` | 形状的名称 如果保留空白,将生成一个唯一的名称 |
| `src` | `string` | 图片的src |
| `left?` | `number` | The <i>x</i> location of the picture shape. |
| `top?` | `number` | The <i>y</i> location of the picture shape. |
| `width?` | `number` | The width of the picture shape. |
| `height?` | `number` | The height of the picture shape. |
