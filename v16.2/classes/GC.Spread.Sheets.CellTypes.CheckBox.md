...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` \| `number` | 单元格类型的标题 |

#### Returns

`any`

如果未设置任何值,则返回标题;否则,返回复选框单元格类型
// 本示例创建一个复选框单元格
var cellType1 = new GC.Spread.Sheets.CellTypes.CheckBox();
cellType1.caption("caption");
cellType1.textTrue("true");
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 复选框是否支持三种状态 |

#### Returns

`any`

如果未设置任何值,则返回复选框是否支持三种状态 否则,返回复选框单元格类型
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `boolean` | 相对于复选框的文本对齐方式 |

#### Returns

`any`

如果未设置任何值,则返回相对于复选框的文本对齐方式;否则,返回复选框单元格类型
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | [`CheckBoxTextAlign`](../enums/GC.Spread.Sheets.CellTypes.CheckBoxTextAlign.md) | 相对于复选框的文本对齐方式 |

#### Returns

`any`

如果未设置值,则返回相对于复选框的文本对齐方式;否则,返回复选框
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 当单元格的值为` false `时,单元格中的文本 |

#### Returns

`any`

如果未设置任何值,则当单元格的值为` false `时返回单元格中的文本 如果设置了值,则返回复选框单元格类型
...
当单元格的值不确定时,获取或设置单元格中的文本(` true `和` false `都不成功)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value?` | `string` | 单元格的值不确定时单元格中的文本 |

#### Returns

`any`

如果未设置任何值,则当单元格的值不确定时,返回单元格中的文本 如果设置了值,则返回复选框单元格类型
...
如果未设置任何值,则当单元格的值为` true `时返回文本 如果设置了值,则返回复选框单元格类型
