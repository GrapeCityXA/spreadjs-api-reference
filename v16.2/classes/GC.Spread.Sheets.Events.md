...
**`param`** *{@link GC.Spread.Sheet.ClipboardActionType}* `action` Indicates the type of the current action.
...
//在单元格中键入不同的值(0,0)如果用户键入无效值,则触发此事件
